 ...
 * Description: Header file for hmac_mgmt_bss_comm.c
 * Author: Hisilicon
 * Create: 2018-08-04
 */
...
/*****************************************************************************
  5 函数声明
*****************************************************************************/
hi_u16 hmac_mgmt_encap_addba_req(hmac_vap_stru *hmac_vap,
                                 hi_u8 *puc_data, dmac_ba_tx_stru *tx_ba, hi_u8 tid);
hi_u16 hmac_mgmt_encap_addba_rsp(hmac_vap_stru *hmac_vap,
                                 hi_u8 *puc_data,
                                 hmac_ba_rx_stru *addba_rsp, hi_u8 tid, hi_u8 status);
hi_u16 hmac_mgmt_encap_delba(hmac_vap_stru *hmac_vap,
                             hi_u8 *puc_data,
                             const mac_action_mgmt_args_stru *action_args);
hi_u32 hmac_mgmt_rx_addba_req(hmac_vap_stru *hmac_vap,
                              hmac_user_stru *hmac_user, const hi_u8 *puc_payload);
hi_u32 hmac_mgmt_rx_addba_rsp(hmac_vap_stru *hmac_vap,
                              hmac_user_stru *hmac_user, const hi_u8 *puc_payload);
hi_u32 hmac_mgmt_rx_delba(const hmac_vap_stru *hmac_vap,
                          hmac_user_stru *hmac_user, const hi_u8 *puc_payload);
...
hi_void hmac_send_sa_query_rsp(mac_vap_stru *mac_vap, hi_u8 *hdr,
                               hi_u8 is_protected);
hi_u32 hmac_start_sa_query(mac_vap_stru *mac_vap, hmac_user_stru *hmac_user,
                           hi_u8 is_protected);
...
hi_void hmac_mgmt_update_assoc_user_qos(hi_u8 *puc_payload, hi_u16 us_msg_len,
