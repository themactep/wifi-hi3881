 ...
 * Description: Header file for hmac_mgmt_ap.c
 * Author: Hisilicon
 * Create: 2018-08-04
 */
...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
#define is_wep_cipher(uc_cipher) ((WLAN_80211_CIPHER_SUITE_WEP_40 == (uc_cipher)) || \
                                  (WLAN_80211_CIPHER_SUITE_WEP_104 == (uc_cipher)))
...
hi_u32 hmac_mesh_update_sta_sup_rates(hi_u8 *puc_sup_rates, hi_u8 sup_rates_len,
                                      hmac_user_stru *hmac_user,
