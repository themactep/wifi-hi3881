 ...
 * Description: Hi1131 Calibration Module Function Interface Definition.
 * Author: Hisilicon
 * Create: 2018-08-04
 */
...
hi_s64 g_ll_mk1_32[3][128] = { /* 3 128 元素个数 */
    {
...
hi1131_complex_stru g_ll_pa_val[128] = { /* 128 元素个数 */
    {1, 0},
    {5, -1},
    {8, -3},
    {12, -4},
...
hi_u32 hmac_rf_cali_dpd_corr_calc(const hi_u32* hi1131_dpd_cali_data_read, hi_u32* hi1131_dpd_cali_data_calc)
{
    ...
    for (us_idx = 0; us_idx < DPD_CALI_LUT_LENGTH ; us_idx++) {
        ...
        dpd_lut_fixed = complex_div_round_closest(hmac_dpd_complex_multiply_const(dpd_lut_fixed,
            512), ll_dpd_base);  /* 512 函数入参 */
