...
hi_u32 hwal_pbuf_convert_2_skb(const oal_net_device_stru *netdev, oal_lwip_buf *lwip_buf,
...
hi_u32 hwal_lwip_notify(const oal_lwip_netif *netif, hi_u32 notify_type);
#endif
#if (_PRE_OS_VERSION_LITEOS == _PRE_OS_VERSION)
