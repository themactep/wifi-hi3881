...
ifeq ($(CFG_LITEOS), y)
HI1131_WIFI_CFLAGS +=-D_PRE_OS_VERSION=_PRE_OS_VERSION_LITEOS -D_PRE_HI113X_FS_DISABLE -D_PRE_WLAN_FEATURE_SCAN_BY_SSID
ifeq ($(CFG_KERNEL_SMP), y)
HI1131_WIFI_CFLAGS +=-D_PRE_LOSCFG_KERNEL_SMP
endif
else
HI1131_WIFI_CFLAGS +=-D_PRE_OS_VERSION=_PRE_OS_VERSION_LINUX
ifeq ($(CFG_BUILTIN), y)
HI1131_WIFI_CFLAGS +=-D_PRE_LINUX_BUILTIN
endif
endif
...
################################device##############################
HI1131_WIFI_CFLAGS += -I$(WIFI_DRIVER_DIR)/../include
HI1131_WIFI_CFLAGS += -I$(WIFI_DRIVER_DIR)/libsec
...
HI1131_WIFI_CFLAGS += -DHISI_WIFI_PLATFORM_$(HISILICON_PLATFORM)
