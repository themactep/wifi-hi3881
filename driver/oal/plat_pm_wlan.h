...
struct wlan_pm_info {
    ...
    volatile hi_u32         wlan_sleep_open_tcxo;    /* 默认device睡眠时关闭晶体 */
...
typedef struct {
    ...
    hi_u16  deepsleep_open_tcxo : 1;
    hi_u16  reserve : 11;  /* reserve 11 bits */
